...
Мне интересно не просто писать код, а строить продукты:

* понимать пользовательские сценарии;
* снижать friction в интерфейсах;
* проектировать масштабируемую архитектуру;
* улучшать UX и производительность;
* принимать технические решения с учётом бизнеса и роста системы.
...
* аналитика должна помогать принимать решения;
* интерфейс должен уменьшать friction;
* технологии должны решать реальные задачи пользователей.
