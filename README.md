...
| [🛢️ NefteTrade](https://transgarant24.ru/) | Full-stack маркетплейс нефтепродуктов для компании из Ростова-на-Дону — аналог Avito для нефтяного рынка. | React · TypeScript · Node.js · Socket.IO · Redis |
